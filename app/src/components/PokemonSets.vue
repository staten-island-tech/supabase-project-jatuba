<template>
  ...
  const POSSIBLE_RARITIES = [
    "Amazing Rare", "Common", "LEGEND", "Promo", "Rare", "Rare ACE", "Rare BREAK",
    "Rare Holo", "Rare Holo EX", "Rare Holo GX", "Rare Holo LV.X", "Rare Holo Star",
    "Rare Holo V", "Rare Holo VMAX", "Rare Prime", "Rare Prism Star", "Rare Rainbow",
    "Rare Secret", "Rare Shining", "Rare Shiny", "Rare Shiny GX", "Rare Ultra", "Uncommon"
  ];
  ...
  async function fetchSets() {
    try {
      ...
      console.log("Fetched sets:", data.data.map(set => set.name)); 
      return data.data;
    } catch (error) {
